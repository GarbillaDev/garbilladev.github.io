        ...
        questions: [
            {
                ...
                card: {
                    title: 'Nmap',
                    text: 'Nmap (Network Mapper) é amplamente usado para mapear redes, identificar hosts e serviços. Ferramenta útil para inventário e auditoria.'
                }
            },
            {
                id: 'wireshark',
                ...
                card: {
                    title: 'Wireshark',
                    text: 'Wireshark é um analisador de protocolos de rede que permite visualizar tráfego e investigar problemas de rede.'
                }
            },
            {
                id: 'masscan',
                ...
                card: {
                    title: 'Masscan',
                    text: 'Masscan é projetado para escanear grandes redes rapidamente — usado para inventário em larga escala.'
                }
            }
        ]
    },
        ...
        questions: [
            {
                ...
                card: {
                    title: 'Forensics',
                    text: 'Forense digital: práticas para coletar, preservar e analisar evidências em incidentes de segurança.'
                }
            },
            {
                id: 'hash',
                ...
                card: {
                    title: 'Hashes',
                    text: 'Hashes geram um digest de dados; são usados para verificar integridade, assinaturas digitais e mais.'
                }
            }
        ]
    },
        ...
        questions: [
            {
                ...
                card: {
                    title: 'IPC',
                    text: 'IPC é uma métrica de eficiência que, junto com a frequência, determina desempenho real do processador.'
                }
            },
            {
                id: 'gpu',
                ...
                card: {
                    title: 'GPU',
                    text: 'GPUs oferecem paralelismo massivo, acelerando renderização, ray tracing e cargas de ML em games.'
                }
            }
        ]
    },
        ...
        questions: [
            {
                ...
                ans: 0,
                card: {
                    title: 'GTA 6 (contexto)',
                    text: 'Títulos AAA empurram limites gráficos, IA e infraestrutura, impulsionando desenvolvimento de hardware e otimizações.'
                }
            }
        ]
    }
...
// AUDIO: beeps simples para digitação/acerto/erro
class Sfx {
    constructor() {
        try {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function onChoose(idx, q) {
        ...
        if (correct) {
            ...
            typeWriteTo(out, `> Resposta incorreta ✕\nResposta correta: ${q.options[q.ans]}`).then(() => {
                nextBtn.disabled = false;
                updateHUD();
            });
        }
    ...
    function saveToLeaderboard(pontos) {
        const name = prompt('Pontuação final: ' + pontos + '\nDigite seu nome para leaderboard (ou deixe em branco para ANON):') || 'ANON';

        let arr = [];
        try {
            arr = JSON.parse(localStorage.getItem('simhack.leaderboard')) || [];
        } catch (e) {
            arr = [];
        }
